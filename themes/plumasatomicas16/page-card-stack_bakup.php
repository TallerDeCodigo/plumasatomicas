...
<header>
		<div class="wrapper normal">
			<nav class="menu">
				...
				<a href="#"><img id="header-logo" width="289" height="56" src="../images/logo.svg"></a>
			</nav>
			<nav class="social">
				<div class="searchbar">
					<input type="text" value="Búsqueda" onfocus="if(this.value == 'Búsqueda') { this.value = ''; }">
					<a><img src="../images/header/search.png"></a>
				</div>
				<a><img id="header-search" src="../images/header/search.png"></a>
				<a class="socc" href="#"><img src="../images/header/fb.png"></a>
				<a class="socc" href="#"><img src="../images/header/tw.png"></a>
				<a class="socc" href="#"><img src="../images/header/yt.png"></a>
				<a class="socc" href="#"><img src="../images/header/in.png"></a>
			</nav>
		</div>
	</header>
	<div id="ficha-icon" style="display:none"><a><img src="../images/ficha-icon2.png"></a></div>
	<div id="menu-resp">
	<div class="wrap-resp">
		...
		<nav>
			...
			<a href="#"><img src="../images/social/wp.png"></a>
		</nav>
		<div id="list-resp">
			<ol>
		...
		<div id="close-icon"><a><img src="../images/close.png"></a></div>
	</div>
	</div>
	<section id="resumen">
	<img id="resumen-bkg" src="../images/2.png">
	<div id="fullpage">
		<div id="prueba-stack" class="section">
		    ...
		    <div class="slide">
				...
				<div id="res-cont" class="wrapper normal">
					<div class="single descrip">
						...
						<img class="ilustracion" src="../images/3.png">
						...
						<a class="mover fp-controlArrow fp-prev"><img src="../images/left.png"></a>
						<a class="mover fp-controlArrow fp-next"><img src="../images/right.png"></a>
					</div>
				</div>
				</div>
			</div>
			...
			<div class="single list" style="display:none">
				...
				<a id="up-btn" class="despla"><img src="../images/up.png"></a>
				<a id="dw-btn" class="despla"><img src="../images/down.png"></a>
			</div>
